...
import { resolveSummary } from '@resolvers/summary.resolver';
...
export const routes: Routes = [
  ...
  {
    path: 'step2/:modelId',
    component: ModelConfiguratorComponent,
    resolve: {
      options: resolveOption,
    },
    canMatch: [canMatchStep2]
  },
  { path: 'step3/:modelId/:colorId/:configId',
    component: SummaryComponent,
    resolve: {
      summary: resolveSummary
    },
    canMatch: [canMatchStep2, canMatchStep3] },
  { path: '**', redirectTo: 'step1', pathMatch: 'full' }
];
